...
<head>
  ...
  <body class="nav-md">
        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index.html" class="site_title"><i class="fa fa-paw"></i> <span>NSS</span></a>
            </div>
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  ...
                  <ul class="dropdown-menu dropdown-usermenu pull-right">
                    ...
                    <li><?= $this->Html->link(__('Log Out'), ['controller' => 'users', 'action' => 'logout'], ['class' => ''], 'fa fa-sign-out pull-right', ['escape'=>false]);?></li>
                  </ul>
                </li>
    ...
    <!-- gauge.js -->
    <?= $this->Html->script('../vendors/bernii/gauge.js/dist/gauge.min') ?>
    <!-- bootstrap-progressbar -->
    ...
    <!-- Flot plugins -->
    <?= $this->Html->script('flot/jquery.flot.orderBars') ?>
    <?= $this->Html->script('flot/date') ?>
    <?= $this->Html->script('flot/jquery.flot.spline') ?>
    <?= $this->Html->script('flot/curvedLines') ?>
